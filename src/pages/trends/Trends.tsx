...
export default function Trends() {
  ...
  return (
    <div className="px-4 pt-8 pb-6">
      ...
      {/* Sport switcher */}
      <div className="mb-4 flex gap-2 overflow-x-auto pb-1" role="group" data-testid="trend-sports">
        {types.map((type) => (
          <button
            key={type}
            type="button"
      ...
      <div className="mb-6 rounded-2xl bg-white p-4 shadow-sm dark:bg-slate-800">
        ...
        <div className="mb-3 flex gap-2" role="group" data-testid="trend-metrics">
        ...
        <WeeklyBarChart buckets={buckets} metric={metric} formatValue={formatMetric} />
      </div>
